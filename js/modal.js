...
$('#confModal').on('show.bs.modal', function(event) {
	...
	$(this).find('.modal-body #confPages').text((item.pages)?item.pages:'-');
	$(this).find('.modal-body #confDoi').text((item.doi)?item.doi:'-');
...
$('#patentModal').on('show.bs.modal', function(event) {
	...
	$(this).find('.modal-body #patentPubDate').text((item.number)?item.pubDate:'-');
	$(this).find('.modal-body #patentNumber').text((item.number)?item.number:'-');
